...
class ExtractConcept():
  ...
  def gen_hier_concepts(self, root_concept_name):
	...
	concepts_id[concept_name].append(self._page_id_name_map[page_id])
        self._pages_name.append(self._page_id_name_map[page_id])
    ...
    return "\n".join(self._pages_name).encode('utf-8') 
...
if __name__ == "__main__":
  ec = ExtractConcept()
  print ec.gen_hier_concepts(sys.argv[1].decode('utf-8'))
  #ec.output()
